...
<div xmlns:x-filament="http://www.w3.org/1999/html"
     ...
     x-data="{
        ...
        startCamera() {
            this.html5QrcodeScanner = new Html5QrcodeScanner('reader-{{ $getName() }}', { fps: 10, qrbox: {width: 500, height: 250} }, false);
...
>
    ...
    <x-filament::modal id="barcode-scanner-modal-{{ $getName() }}" width="xl" :close-by-clicking-away="false">
        <x-slot name="header">
        ...
        <div class="p-4">
            <div id="scanner-container">
                <div id="reader-{{ $getName() }}" width="900px" height="300px"></div>
            </div>
        </div>
